...
public class SwingController
    ...
    private JMenuItem searchDictionaryMenuItem;
    private JMenuItem historyMenuItem;
    private JMenuItem wordGameMenuItem;
     ...
     * Called by SwingViewerBuilder, so that SwingController can setup event handling
     */
    public void setSearchDictionaryMenuItem(JMenuItem mi) {
        searchDictionaryMenuItem = mi;
        mi.addActionListener(this);
    }
     ...
     * Called by SwingViewerBuilder, so that SwingController can setup event handling
     */
    public void setHistoryMenuItem(JMenuItem mi) {
        historyMenuItem = mi;
        mi.addActionListener(this);
    }
     ...
     * Called by SwingViewerBuilder, so that SwingController can setup event handling
     */
    public void setWordGameMenuItem(JMenuItem mi) {
        wordGameMenuItem = mi;
        mi.addActionListener(this);
    }
...
//        doCommonZoomUIUpdates();
    ...
    /**
    * Method to display Dictionary Pane.
    *
    */
        ...
        try {
            if (source == openFileMenuItem || source == openFileButton) {
                ...
                try {
                    ...
                    } else if(source == searchDictionaryMenuItem){
                        showDictionaryPane();
