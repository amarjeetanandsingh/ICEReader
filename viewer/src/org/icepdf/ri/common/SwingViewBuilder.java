 ...
 * <p/>
 * <li>public JMenu buildDictionaryMenu()
 * <ul>
 * <li>public JMenuItem buildSearchMenuItem()</li>
 * <li>public JMenuItem buildHistoryMenuItem()</li>
 * <li>public JMenuItem buildWordGameMenuItem()</li>
 * </ul>
 * </li>  <!-- buildDtionaryMenu() -->
 * <p/>
...
public class SwingViewBuilder {
    ...
    public JMenuBar buildCompleteMenuBar() {
        ...
        addToMenuBar(menuBar, buildDictionaryMenu());
    ...
    public JMenu buildDictionaryMenu() {
        JMenu dictionaryMenu = new JMenu(messageBundle.getString("viewer.menu.dictionary.label"));
        dictionaryMenu.setMnemonic(buildMnemonic(messageBundle.getString("viewer.menu.dictionary.mnemonic").charAt(0)));
        addToMenu(dictionaryMenu, buildSearchDictionaryMenuItem());
        addToMenu(dictionaryMenu, buildHistoryMenuItem());
        addToMenu(dictionaryMenu, buildWordGameMenuItem());
        return dictionaryMenu;
    }

    public JMenuItem buildSearchDictionaryMenuItem() {
        JMenuItem mi = makeMenuItem(messageBundle.getString("viewer.menu.dictionary.searchDictionary.label"), null);
    ...
    public JMenuItem buildHistoryMenuItem() {
        JMenuItem mi = makeMenuItem(messageBundle.getString("viewer.menu.dictionary.history.label"), null);
        mi.setMnemonic(buildMnemonic(messageBundle.getString("viewer.menu.dictionary.history.mnemonic").charAt(0)));
        if (viewerController != null)
            viewerController.setHistoryMenuItem(mi);
        return mi;
    }


    public JMenuItem buildWordGameMenuItem() {
        JMenuItem mi = makeMenuItem(messageBundle.getString("viewer.menu.dictionary.wordGame.label"), null);
        mi.setMnemonic(buildMnemonic(messageBundle.getString("viewer.menu.dictionary.wordGame.mnemonic").charAt(0)));
        if (viewerController != null)
            viewerController.setWordGameMenuItem(mi);
        return mi;
    }
